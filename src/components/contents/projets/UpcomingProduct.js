        ...
        <List>
          <ListItem className={classes.item}>
              ...
              <Box flexGrow={1} pt={1}>
                ...
                <Box>
                  <Typography
                    ...
                    color="textSecondary"
                  >
                    Stay in touch with your team, without call overload
                  </Typography>
                </Box>
              </Box>
            ...
            <Box>
              <Button
                variant="text"
                className={clsx(classes.btnSize, classes.btnHover)}
                startIcon={<AddIcon style={{ fontSize: "12px" }} />}
              >
                <span className={classes.spanHover}>follow (83)</span>
              </Button>
            </Box>
          </ListItem>
          <Divider />
          <ListItem className={classes.item}>
              ...
              <Box flexGrow={1}>
                <Box>
                  <Typography
                    className={clsx(classes.typoSize, classes.typoWeight)}
                  >
                    Jira Integration Plus for Strive
                  </Typography>
                </Box>
                <Box>
                  <Typography
                    ...
                    className={classes.typoSize}
                  >
                    Connect Jira to Stride - for Jira Server and Cloud
                  </Typography>
                </Box>
              </Box>
            ...
            <Box>
              <Button
                ...
                startIcon={<AddIcon style={{ fontSize: "12px" }} />}
              >
                <span className={classes.spanHover}>follow (87)</span>
              </Button>
            </Box>
          </ListItem>
          <Divider />
          <ListItem className={classes.item}>
              ...
              <Box flexGrow={1}>
                ...
                <Box>
                  <Typography
                    ...
                    className={classes.typoSize}
                  >
                    Survey Tools To Get Feedback On Media and Visuals
                  </Typography>
                </Box>
              </Box>
            ...
            <Box>
              <Button
                ...
                startIcon={<AddIcon style={{ fontSize: "12px" }} />}
              >
                <span className={classes.spanHover}>follow (321)</span>
              </Button>
            </Box>
          </ListItem>
          <ListItem className={classes.item}>

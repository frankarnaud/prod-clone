    ...
    <Card className={classes.card}>
        ...
        <Box display="flex" justifyContent="space-around">
          <Box mx={1}>
            ...
            <Button
              ...
              disableElevation
              onClick={handleLoginWith.bind(this, "tw")}
          ...
          <Box mx={1}>
            <Button
              ...
              disableElevation
              onClick={handleLoginWith.bind(this, "fb")}
          ...
          <Box mx={1}>
            <Button
              ...
              onClick={handleLoginWith.bind(this, "go")}
            >
              <img
                src={google}
                alt="Google"
      ...
      <Box pt={2} pb={3}>
        <Typography color="textSecondary" variant="caption">
          We'll never post to any of your accounts whithout your permission.
        </Typography>
      </Box>
    </Card>
  );

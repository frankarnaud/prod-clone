    ...
    return (
        <Box display="flex" pt={2} className={classes.textSize}>
            <Box mr={1}>
                ...
                onClick={openLogDialog} className={classes.textSize}>LOG IN</Button>
            </Box>
            <Box><Button variant="contained" fullWidth disableElevation className={classes.btn}
             size="small" onClick={openSignDialog}>
                 SIGN UP
             </Button>
            </Box>
        </Box>
